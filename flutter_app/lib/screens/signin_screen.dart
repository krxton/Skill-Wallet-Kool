...
class _RegisterScreenState extends State<RegisterScreen> {
  // 0 = Social (ซ้ายใน Figma), 1 = Additional Info (ขวาใน Figma)
  int step = 0; // ✅ เริ่มที่หน้าแรกชัวร์
  ...
  Widget _firstPage() {
    return ListView(
      ...
      children: [
        Text(
          'SIGN-IN TO\nSKILL WALLET KOOL',
          style: GoogleFonts.luckiestGuy(fontSize: 28, color: sky, height: 1.1),
        ),
  ...
  InputDecoration _dec() => InputDecoration(
    ...
    fillColor: fieldBg,
    hintText: '',
    hintStyle: GoogleFonts.luckiestGuy(color: Colors.black54, fontSize: 16),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: Text('REGISTER', style: GoogleFonts.luckiestGuy(color: sky, fontSize: 28)),
        leading: IconButton(
      ...
      // ✅ ใช้ IndexedStack (ไม่มีทาง "ไม่มี child")
      body: IndexedStack(
          ...
          child: GestureDetector(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('BACK', style: GoogleFonts.luckiestGuy(fontSize: 24, color: backPink)),
              ],
            ),
          ),
        ),
